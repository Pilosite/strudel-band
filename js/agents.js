...
3. For DRUMS: use FULL sample names like s("RolandTR909_bd") - DO NOT use .bank()
4. Use stack() to layer multiple drum patterns: stack(s("RolandTR909_bd ~ ~ ~"), s("~ ~ RolandTR909_sd ~"), s("RolandTR909_hh*4"))
...
9. DRUM SAMPLES: RolandTR909_bd, RolandTR909_sd, RolandTR909_hh, RolandTR909_oh, RolandTR909_cp, RolandTR909_rim
...
EXAMPLES:
- Drums basic: stack(s("RolandTR909_bd ~ RolandTR909_sd ~").gain(0.9), s("RolandTR909_hh*8").gain(0.3))
- Drums funky: stack(s("RolandTR909_bd ~ [RolandTR909_sd ~] [~ RolandTR909_bd]").gain(0.9), s("RolandTR909_hh*8").gain(0.3), s("~ ~ RolandTR909_cp ~").gain(0.4))
...
Generate your pattern now:`;
    ...
    getDemoPattern(prompt) {
        ...
        const patterns = {
            drums: {
                default: 'stack(s("RolandTR909_bd ~ RolandTR909_sd ~").gain(0.9), s("RolandTR909_hh*8").gain(0.3))',
                funky: 'stack(s("RolandTR909_bd ~ [RolandTR909_sd ~] [~ RolandTR909_bd]").gain(0.9), s("RolandTR909_hh*8").gain(0.3), s("~ ~ RolandTR909_cp ~").gain(0.4))',
                minimal: 'stack(s("RolandTR909_bd ~ ~ ~ RolandTR909_sd ~ ~ ~").gain(0.7), s("RolandTR909_hh*4").gain(0.2))',
                intense: 'stack(s("RolandTR909_bd*2 ~ RolandTR909_sd ~ RolandTR909_bd ~ RolandTR909_sd RolandTR909_bd").gain(0.95), s("RolandTR909_hh*16").gain(0.4), s("RolandTR909_cp*2").gain(0.5))',
                ambient: 'stack(s("~ RolandTR909_bd ~ RolandTR909_sd").room(0.6).gain(0.5), s("RolandTR909_hh*4").room(0.5).gain(0.15))'
            },
            bass: {
...
class Band {
    ...
    initAgents() {
        ...
        const defaultPatterns = {
            drums: 'stack(s("RolandTR909_bd ~ RolandTR909_sd ~").gain(0.9), s("RolandTR909_hh*8").gain(0.3))',
