...
3. For DRUMS: use s("bd sd hh cp").bank("RolandTR808") - sounds: bd (kick), sd (snare), hh (hihat), cp (clap)
...
9. Available drum banks: RolandTR808, RolandTR707, AkaiLinn, ViscoSpaceDrum
...
EXAMPLES:
- Drums basic: stack(s("bd ~ sd ~").bank("RolandTR808").gain(0.9), s("hh*8").bank("RolandTR808").gain(0.3))
- Drums funky: stack(s("bd ~ [sd ~] [~ bd]").bank("RolandTR808").gain(0.9), s("hh*8").bank("RolandTR808").gain(0.3), s("~ ~ cp ~").bank("RolandTR808").gain(0.4))
...
Generate your pattern now:`;
    ...
    getDemoPattern(prompt) {
        ...
        const patterns = {
            drums: {
                default: 'stack(s("bd ~ sd ~").bank("RolandTR808").gain(0.9), s("hh*8").bank("RolandTR808").gain(0.3))',
                funky: 'stack(s("bd ~ [sd ~] [~ bd]").bank("RolandTR808").gain(0.9), s("hh*8").bank("RolandTR808").gain(0.3), s("~ ~ cp ~").bank("RolandTR808").gain(0.4))',
                minimal: 'stack(s("bd ~ ~ ~ sd ~ ~ ~").bank("RolandTR808").gain(0.7), s("hh*4").bank("RolandTR808").gain(0.2))',
                intense: 'stack(s("bd*2 ~ sd ~ bd ~ sd bd").bank("RolandTR808").gain(0.95), s("hh*16").bank("RolandTR808").gain(0.4), s("cp*2").bank("RolandTR808").gain(0.5))',
                ambient: 'stack(s("~ bd ~ sd").bank("RolandTR808").room(0.6).gain(0.5), s("hh*4").bank("RolandTR808").room(0.5).gain(0.15))'
            },
            bass: {
...
class Band {
    ...
    initAgents() {
        ...
        const defaultPatterns = {
            drums: 'stack(s("bd ~ sd ~").bank("RolandTR808").gain(0.9), s("hh*8").bank("RolandTR808").gain(0.3))',
